...
const {taskFolder, IOTOFrameworkPath, LTDListInputSectionHeading} = app.plugins.plugins["ioto-settings"].settings;
const overviewPage = `${IOTOFrameworkPath}/Dashboard/Project-Inputs-Overview.md`;
...
const args = {
	...
	IOOHeading: LTDListInputSectionHeading,
