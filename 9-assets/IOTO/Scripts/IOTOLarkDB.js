function IOTOLarkDB(tp) {
  let MyNocoDB = tp.user.IOTONocoDB(tp);
  return class MyLarkDB extends MyNocoDB {
    constructor(nocoDBSettings) {
      super(
        nocoDBSettings,
        {
          dbName: "Lark",
          recordIdPropertyName: "larkRecordID",
          recordIdPropertyNameForDownload: "larkDownloadRecordID",
          recordIdName: "record_id",
          useDate: true,
          apiUrlRoot: "https://open.larksuite.com/open-apis/bitable/v1/",
          recordUrlRoot: "https://larksuite.com/base/",
        },
        {
          baseIDName: "appToken",
